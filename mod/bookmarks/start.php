...
function bookmark_url($entity) {
	...
	$title = elgg_get_friendly_title($title);
       ...
       //Si la entidad es una red tematica, al hacer clic  lo redirecciona a la vista del MArcador ubicada en el plugin de Redes Tematicas
        $entidad= get_entity($entity->container_guid);
        if($entidad->getSubtype()=="red_tematica"){
          return "redes_tematicas/marcadores/".$entity->container_guid."/view/".$entity->guid; 
        }
        //Si la entidad es un grupo de Investigacion,  lo redirecciona a la vista del Marcador del Grupo
        else if($entidad->getSubtype()=="grupo_investigacion"){
          return "grupo_investigacion/marcadores/".$entity->container_guid."/view/".$entity->guid;
        }
         //Si la entidad es una institucion,  lo redirecciona a la vista del Marcador de la institucion
        else if($entidad->getSubtype()=="institucion"){
          return "instituciones/marcadores/".$entity->container_guid."/view/".$entity->guid;
        }
