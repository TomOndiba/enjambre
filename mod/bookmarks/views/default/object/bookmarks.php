...
//if el container es una red tematica o un grupo de investigación, no se muestra el menu
if ($container->getSubtype() == "red_tematica" || $container->getSubtype() == "grupo_investigacion") {
