...
/**
 * Vista que permite ver los niveles de feria registrados en el sistemas
 * @author DIEGOX_CORTEX
 */

elgg_load_js('acciones_nivel');
$nivelF = $vars['lista_niveles'];
$contenido = "";
...
if (!empty($nivelF)) {
    foreach ($nivelF as $nivel) {
        $href_eliminar = $nivel['href_elim'];
        $href_editar = $nivel['href_edit'];
...
//                . "</div>";
    ...
    $contenido = "No existen niveles de feria registradas.";
}
 ...
 ?>
    <div class="content-coordinacion">
        <div class="titulo-coordinacion">
            <h2>Listado de Niveles de la Feria</h2>
        </div>
<?php
...
echo <<<HTML
<div style='display:none;' id="dialog-confirm-nivel" title="Confirmación">
  <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>¿Está seguro que desea eliminar el nivel de feria?</p>
</div>
