...
$tipo_documento_input = elgg_view('input/dropdown', array('name' => 'tipo_documento', 'id' => 'tipoDocumento', 'class' => 'select',
    'style'=>'margin-top:10px','options_values' => array(
...
<h2 class="title-legend">Registro de Estudiante</h2>
<div class="registro">
    <div class="consulta-estudiante">
        <p>Ingresa tu número de documento para validarte en el sistema.</p><br/>
        <div class="div-datos21">
        ...
        <div onclick="mostrarDatosRegistro(this)" class="div-button row link-button search-estudiante" style="width: 120px;text-align:center; margin-top: 21.5px !important;
             margin-left: 50px; cursor:pointer; background-color: #5ca6bc">Consultar
        </div>
    </div>
    <div id="error" class="error-consulta" style="display: none">
    ...
    <div style="display: none;" class="registro" id="registroUsuario">
        ...
        <div style="display: none; text-align: center; width: 100%" class="registro" id="loader">
...
<script>
        ...
        elgg.get('ajax/view/usuario/busqueda_documento', {
            ...
            success: function (result, success, xhr) {
                ...
                if (datosFinal.user == false) {
                    lanzarMensajeError(datosFinal.mensaje);
                    form.hide();
                    form.html(contenido);
                } else {
                    form.html(contenido);
    ...
    function lanzarMensajeError(msj) {
        $("#error").show().html(msj);
    }
