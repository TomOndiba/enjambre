...
$body = elgg_view('page/elements/profile/body', $vars);
    ...
    <body>
        ...
        <script>
            window.onload=function() {
                var altura1 = $(".left").height();
                var altura2 = $(".right").height();
                if (altura1 < altura2) {
                    //$(".left").css("min-height",altura2+"px");
                } else {
                    $(".right").css("min-height",altura1+"px");
                }                
            }
        </script>
    </body>
