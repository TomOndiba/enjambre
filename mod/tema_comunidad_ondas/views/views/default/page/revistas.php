    ...
    <body>
        ...
        <div class="todo">
            <div class="left-inicio">
                    ...
                    <div class="header-menu">
                        <nav>
                            <ul>
                                ...
                                <li onclick="location.href = '<?php echo $site_url ?>contenidos'" class="fc-azul">Contenidos Digitales</li><li onclick="location.href = '<?php echo $site_url ?>contenidos/tutoriales'" class="fc-azul">Tutoriales</li>
                ...
                <div class="contenido">
                    <?php echo elgg_view('revistas/listar_revistas_2', $params); ?>
                </div>
