...
/**
 * Action que permite registrar una evaluación a un informe de investigación de formato 4
 * categoria innovacion - componente investigacion, hecha por 
 * un evaluador.
 * 
...
$puntaje_relacion_pregunta = get_input('puntaje_relacion_pregunta');
...
$puntaje_conocimientos_conceptos = get_input('puntaje_conocimientos_conceptos');
...
if (empty($guid_evaluacion_hecha)) {
    $evaluacion = new ElggEvalInformeInvDiariCcampoINN_inv();
}
...
$evaluacion->puntaje_relacion_pregunta = $puntaje_relacion_pregunta;
$evaluacion->subtotal_coherencia = $subtotal_coherencia;
//RUTA_INDAGACION
$evaluacion->puntaje_diseño_metodologico = $puntaje_diseño_metodologico;
$evaluacion->puntaje_conocimientos_conceptos = $puntaje_conocimientos_conceptos;
