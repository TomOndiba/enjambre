...
/**
 * Action que permite registrar una evaluación a una expósicion en puesto de formato 3.1
 * 
...
$obs = get_input('obs');
$guid_evaluacion_hecho = get_input('guid_evaluacion_hecho');
...
$evaluacion = get_entity($guid_evaluacion_hecho);
if (empty($guid_evaluacion_hecho)) {
    $evaluacion = new ElggEvalSustentacionOral_inn();
}
...
if ($result) {
    ...
    //if(!check_entity_relationship($guid_investigacion, 'evaluada_3_en_' . $guid_feria . '_con', $evaluacion->guid))
