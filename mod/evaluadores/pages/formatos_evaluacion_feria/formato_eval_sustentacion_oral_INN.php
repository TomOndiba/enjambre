 ...
 * formato_eval_sustentacion_oral_INN
 * 
...
if(!empty($guid_evaluacion)){
    $url1 = elgg_get_site_url() . "action/bitacoras/print?id=" . $guid_evaluacion . '&bit=98';
...
$content = elgg_view_form('formatos_evaluacion_feria/formato_eval_sustentacion_oral_INN', NULL, $params);
