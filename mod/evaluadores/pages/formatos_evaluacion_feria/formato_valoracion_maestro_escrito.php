 ...
 * formato_valoracion_maestro_escrito
 * 
...
if(!empty($guid_evaluacion)){
    $url1 = elgg_get_site_url() . "action/bitacoras/print?id=" . $guid_evaluacion . '&bit=95';
...
$content = elgg_view_form('formatos_evaluacion_feria/formato_valoracion_maestro_escrito', NULL, $params);
