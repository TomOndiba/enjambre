 ...
 */
class ElggEvaluarInformeInvCuadCampoINN_inv extends ElggObject {
    ...
    protected function initializeAttributes() {
        ...
        $this->attributes['puntaje_claridad_pregunta'] = "";
        $this->attributes['subtotal_coherencia'] = "";
        //RUTA_INDAGACION
        $this->attributes['puntaje_diseño_metodologico'] = "";
        $this->attributes['puntaje_conceptos_investigacion'] = "";
    ...
    function save() {
        ...
        if ($guid) {
            ...
            create_metadata($guid, 'puntaje_claridad_pregunta', $this->attributes['puntaje_claridad_pregunta'], 'text', $user_guid, ACCESS_LOGGED_IN, false);
            ...
            create_metadata($guid, 'puntaje_conceptos_investigacion', $this->attributes['puntaje_conceptos_investigacion'], 'text', $user_guid, ACCESS_LOGGED_IN, false);
