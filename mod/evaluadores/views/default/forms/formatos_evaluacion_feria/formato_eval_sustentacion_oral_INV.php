...
//COHERENCIA
$lbl_apropiacion = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:lbl_apropiacion');
$lbl_puntaje_presenta_claridad = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:puntaje_presenta_claridad');
$lbl_puntaje_explica_fundamentos = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:puntaje_explica_fundamentos');
$lbl_puntaje_proceso_metodologico = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:puntaje_proceso_metodologico');
$lbl_puntaje_innovacion_lograda = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:puntaje_innovacion_lograda');
//CAPACIDADES
$lbl_capacidades = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:lbl_capacidades');
$lbl_puntaje_evidentes_capacidades = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:puntaje_evidentes_capacidades');
//Puesto
$lbl_puesto = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:lbl_puesto');
$lbl_puntaje_diseño_investigativo = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:puntaje_diseño_investigativo');
//ANeXOs
$lbl_puntaje_total = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:lbl_puntaje_total');
$lbl_obs = elgg_echo('evaluador:formtaos:evaluar:exposicionoral:obs');
...
$body =   "<input type='hidden' name='guid_invest' value='$guid_inv'>"
        ...
        . "<table class='tabla-coordinador'>"
            ...
            . "<tr>"
                ...
                . "<td><input type='number' name='puntaje_presenta_claridad' id='puntaje_presenta_claridadINV' value='$puntaje_presenta_claridad' required></td>"
            . "</tr>"
            . "<tr>"
                . "<td COLSPAN=5>$lbl_puntaje_explica_fundamentos</td>"
                . "<td><input type='number' name='puntaje_explica_fundamentos' id='puntaje_explica_fundamentosINV' value='$puntaje_explica_fundamentos' required></td>"
            . "</tr>"
            ."<tr>"
                . "<td COLSPAN=5>$lbl_puntaje_proceso_metodologico</td>"
                . "<td><input type='number' name='puntaje_proceso_metodologico' id='puntaje_proceso_metodologicoINV' value='$puntaje_proceso_metodologico' required></td>"
            . "</tr>"
            . "<tr>"
                . "<td COLSPAN=5>$lbl_puntaje_innovacion_lograda</td>"
                . "<td><input type='number' name='puntaje_innovacion_lograda' id='puntaje_innovacion_logradaINV' value='$puntaje_innovacion_lograda' required></td>"
            . "</tr>"
            . "<tr>"
                . "<td COLSPAN=5><center><h4>$lbl_subtotal</h4></center></td>"
                . "<td><input type='number' name='subtotal_apropiacion' id='subtotal_apropiacionINV' value='$subtotal_apropiacion' readonly></td>"
            . "</tr>"
            //Capacidades
            . "<tr>"
                . "<td rowspan=2>$lbl_capacidades</td>"
                . "<td COLSPAN=5>$lbl_puntaje_evidentes_capacidades</td>"
                . "<td><input type='number' name='puntaje_evidentes_capacidades' id='puntaje_evidentes_capacidadesINV' value='$puntaje_evidentes_capacidades' required></td>"
            . "</tr>"
            . "<tr>"
                . "<td COLSPAN=5><center><h4>$lbl_subtotal</h4></center></td>"
                . "<td><input type='number' name='subtotal_capacidades' id='subtotal_capacidadesINV' value='$subtotal_capacidades' readonly></td>"
            . "</tr>"
            //PUESTO
            . "<tr>"
                . "<td rowspan=2>$lbl_puesto</td>"
                . "<td COLSPAN=5>$lbl_puntaje_diseño_investigativo</td>"
                . "<td><input type='number' name='puntaje_diseño_investigativo' id='puntaje_diseño_investigativoINV' value='$puntaje_diseño_investigativo' required></td>"
            . "</tr>"
            . "<tr>"
                . "<td COLSPAN=5><center><h4>$lbl_subtotal</h4></center></td>"
                . "<td><input type='number' name='subtotal_puesto' id='subtotal_puestoINV' value='$subtotal_puesto' readonly></td>"
            . "</tr>"
            . "<tr>"
                . "<td COLSPAN=6><center><h4>$lbl_puntaje_total</h4></center></td>"
                . "<td><input type='number' name='puntaje_total' id='puntaje_totalINV' value='$puntaje_total' readonly>"
            . "</td>"
            . "<tr>"
