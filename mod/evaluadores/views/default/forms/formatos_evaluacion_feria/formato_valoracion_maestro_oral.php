...
/**
 * Form donde se llenan los datos necesarios de la evaluación del maestro oral
 * 
...
$titulo_general = elgg_echo('evaluador:formtaos:evaluar:maestro:escrito:title:oral');
...
$body = "<input type='hidden' name='guid_invest' value='$guid_inv'>"
        ...
        . "</tr>"
        . "<tr>"
        . "<td>$lbl_colaborador</td> <td COLSPAN=5><input type='text' name='name_grupo' value='$colaborador' size='180' readonly></td>"
        . "</tr>"
        . "<tr>"
        . "<td>$lbl_nombre_grupo</td> <td COLSPAN=5><input type='text' name='name_inv' value='$nombre_grupo' size='180' readonly></td>"
        . "</tr>"
        . "<tr>"
        . "<td>$lbl_name_Inv</td> <td COLSPAN=5><input type='text' name='colaborador' value='$inv_name' size='180' readonly></td>"
        . "</tr>"
        . "<tr>"
