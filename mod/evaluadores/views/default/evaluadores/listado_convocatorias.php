...
foreach ($entities as $entity) {
    ...
    $investigaciones = elgg_get_relationship($user, "es_evaluador_de");
    //obtiene las investigaciones asignadas que pertenecen  a una convocatoria especifica
    $investigaciones_conv = elgg_investigaciones_entity($investigaciones, $entity->guid);
    $url = elgg_get_site_url() . "evaluadores/listar_investigaciones_convocatorias/" . $entity->guid;
...
if (sizeof($entities) != 0) {
    ...
    echo "No es Evaluador de ninguna convocatoria";
}
