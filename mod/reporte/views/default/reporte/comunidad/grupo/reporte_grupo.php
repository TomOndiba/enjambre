...
$datos = elgg_get_estaditicas_grupo($grupo);
...
foreach ($lista as $item) {
    ...
    if (!in_array($item->grupo_etnico, $filtros['etnia'])) {
        $filtros['etnia'][] = $item->grupo_etnico;
    }
    ...
    if (!in_array($subtype, $filtros['tipo_user'])) {
        $filtros['tipo_user'][] = $subtype;
    }
    $edad= elgg_get_edad($item);
    ...
    <div>
            ...
            <div id="listados">
                ...
                <div id="imprimir">
                    ...
                    <table id="tabla-datos-grupo" class="responstable">
                        <thead><tr><th>Nombre</th><th>Email</th><th>Edad</th><th>Tipo de Usuario</th><th>Etnia</th><th>Genero</th><th>Curso</th><th>Institución</th><th>Tipo de Institucion</th></tr></thead>
        ...
        <script>
            ...
            function verInvestigaciones(element) {
                ...
                elgg.get('ajax/view/reporte/comunidad/grupo/investigaciones/investigaciones_grupo', {
                    timeout: 30000,
                    data: {
                        grupo: "<?php echo $guid ?>",
                    },
