<h2 class="titulo-reportes title-legend">Reportes Por Investigación</h2>
...
<div id="investigaciones"> </div>


<div id="tablausuariogrupo">
...
<script>
    ...
    $(document).ready(function() {
        $("#inst").live("change", function(evento) {
            ...
            elgg.get('ajax/view/reporte/comunidad/investigaciones/listar_grupos_reporteInv', {
                timeout: 30000,
                data: {
                    institucion: inst,
                    id: "grupoR",
        ...
        $("#grupoR").live("change", function(evento) {
            var grupo = $("#grupoR").val();

            elgg.get('ajax/view/reporte/comunidad/investigaciones/listar_investigaciones_grupo', {
                timeout: 30000,
                data: {
                    id: 'invGr',
                    grupo: grupo,
        ...
        $("#invGr").live("change", function(evento) {
            var inv = $("#invGr").val();
            //alert('LLEGA '+inv);
            elgg.get('ajax/view/reporte/comunidad/investigaciones/reporte_investigaciones', {
                timeout: 30000,
                data: {
                    inv: inv,
                    pageowner: elgg.get_page_owner_guid()
