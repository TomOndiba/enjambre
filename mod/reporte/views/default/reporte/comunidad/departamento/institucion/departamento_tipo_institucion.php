<h2 class="titulo-reportes title-legend">Instituciones de un Departamento por Tipo</h2>
...
$select_departamento = elgg_view('input/dropdown', array(
    ...
    'onchange' => 'verTipoInstitucionDepartamento(this)',
...
<script>
    function verTipoInstitucionDepartamento(element) {
        var departamento = $(element).val();
        elgg.get('ajax/view/reporte/comunidad/departamento/institucion/ver_tipo_institucion', {
            timeout: 30000,
            data: {
