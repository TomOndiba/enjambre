<h2 class="titulo-reportes title-legend">Reportes  de Ferias en la que ha participado un Grupo</h2>
...
<script>
    ...
    $(document).ready(function() {
     $("#inst").live("change", function(evento) {
      ...
      $("#grupos-feria").live("change", function(evento) {
        var grupo = $("#grupos-feria").val();
       
        elgg.get('ajax/view/reporte/grupo/feria/reporte_feria_grupo', {
            timeout: 30000,
            data: {
                grupo: grupo,
                pageowner: elgg.get_page_owner_guid()
