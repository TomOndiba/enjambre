<h2 class="titulo-reportes title-legend">Reporte Calificación por Asesor en Convocatoria</h2>
...
<script>
    function verConvocatoriasByDpto(element){
        ...
        $("#result").empty();
        elgg.get('ajax/view/reporte/asesor/calificacion_asesor_conv/convocatorias_by_dpto_as2', {
            timeout: 30000,
            data: {
