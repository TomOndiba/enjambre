...
$datos = elgg_get_estadisticas_proyectos_asesor($asesor);
    ...
    <div>
        ...
        <div class="tabs-asesores">
            ...
            <div id="listados">
                <div class="filtros">
                    ...
                    <br>
                  <div id="imprimir">
                    <h2 class="titulo-reportes">Investigaciones Asignadas al Asesor <?php echo $as->name." ".$as->apellidos?></h2>
                    <br>
                    <form action="http://<?php echo elgg_get_url_server()?>/reporte/imprimir_excel.php" method="post" target="_blank" id="FormularioExportacion">
                        <a onclick="imprimirExcel('tabla-invest-asesor')">Exportar a Excel</a>
                        <input type="hidden" id="contenido_excel" name="contenido" />
                    </form>
                    
                    <table id="tabla-invest-asesor" class="responstable">
        ...
        <script>
            ...
            function consultarTabla() {
                $("#tabla-invest-asesor_filter label input").val("");
                var busqueda = "";
                ...
                $("#tabla-invest-asesor_filter label input")
                        .val(busqueda)
                        .change();
            }
            ;
            ...
            $(document).ready(function() {
                var table = $('#tabla-invest-asesor').dataTable({
                    "bPaginate": false
                });
                $("#listados").hide();
            });
