...
$datos = elgg_get_estadisticas_evaluadores($feria, "es_evaluador_feria");
    ...
    <div>
        ...
        <div class="tabs-asesores">
            ...
            <div id="listados">
                ...
                <div id="imprimir">
                    <br>
                    <h2 class="titulo-reportes">Evaluadores de <?php echo $feria->name?></h2>
                    <br>
                    <form action="http://<?php echo elgg_get_url_server()?>/reporte/imprimir_excel.php" method="post" target="_blank" id="FormularioExportacion">
                        <a onclick="imprimirExcel('tabla-evaluadores-feria')">Exportar a Excel</a>
                        <input type="hidden" id="contenido_excel" name="contenido" />
                    </form>
                    <table id="tabla-evaluadores-feria" class="responstable">
        ...
        <script>
            ...
            function consultarTabla() {
                $("#tabla-evaluadores-feria_filter label input").val("");
                var busqueda = "";
                ...
                $("#tabla-evaluadores-feria_filter label input")
                        .val(busqueda)
                        .change();
            }
            ;
            ...
            $(document).ready(function() {
                var table = $('#tabla-evaluadores-feria').dataTable({
                    "bPaginate": false
                });
                $("#listados").hide();
            });
