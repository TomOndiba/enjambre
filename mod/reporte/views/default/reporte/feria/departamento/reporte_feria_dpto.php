...
$datos = elgg_get_ferias_departamento($dpto);
    ...
    <div>
        ...
        <div class="tabs-asesores">
            ...
            <div id="listados">
                <div class="filtros">
                  ...
                  <br>
                <div id="imprimir">
                    <h2 class="titulo-reportes">Ferias del Departamento <?php echo $dpto?></h2>
                    <br>
                    <form action="http://<?php echo elgg_get_url_server()?>/reporte/imprimir_excel.php" method="post" target="_blank" id="FormularioExportacion">
                        <a onclick="imprimirExcel('tabla-datos-feria')">Exportar a Excel</a>
                        <input type="hidden" id="contenido_excel" name="contenido" />
                    </form>
                    <table id="tabla-datos-feria" class="responstable">
                        <thead><tr><th>Nombre</th><th>Tipo de Feria</th><th>Departamento</th><th>Fecha Inicio</th><th>Fecha Fin</th><th>Áreas</th><th>Niveles</th></tr></thead>
        ...
        <script>
            ...
            function consultarTablaFeria() {
                $("#tabla-datos-feria_filter label input").val("");
                var busqueda = "";
                ...
                $("#tabla-datos-feria_filter label input")
                        .val(busqueda)
                        .change();
            }
            ;
            ...
            $(document).ready(function() {
                var table = $('#tabla-datos-feria').dataTable({
                    "bPaginate": false
                });
                $("#listados").hide();
            });
