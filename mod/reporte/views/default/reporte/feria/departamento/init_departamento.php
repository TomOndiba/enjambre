<h2 class="titulo-reportes title-legend">Reporte de Ferias por Departamento</h2>
...
<script>
    function verFeriasDpto(element) {
        var departamento = $(element).val();
        elgg.get('ajax/view/reporte/feria/departamento/reporte_feria_dpto', {
            timeout: 30000,
            data: {
