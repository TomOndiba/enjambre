...
$datos = elgg_get_convocatias_departamento($dpto);
    ...
    <div>
        ...
        <div class="tabs-asesores">
            ...
            <div id="listados">
                ...
                <div id="imprimir">
                    <br>
                    <h2 class="titulo-reportes">Convocatorias en el Departamento <?php echo $dpto?></h2>
                    <form action="http://<?php echo elgg_get_url_server()?>/reporte/imprimir_excel.php" method="post" target="_blank" id="FormularioExportacion">
                        <a onclick="imprimirExcel('tabla-convocatoria-dpto')">Exportar a Excel</a>
                        <input type="hidden" id="contenido_excel" name="contenido" />
                    </form>
                    <table id="tabla-convocatoria-dpto" class="responstable">
        ...
        <script>
            ...
            function consultarTabla() {
                $("#tabla-convocatoria-dpto_filter label input").val("");
                var busqueda = "";
                ...
                $("#tabla-convocatoria-dpto_filter label input")
                        .val(busqueda)
                        .change();
            }
            ;
            ...
            $(document).ready(function() {
                var table = $('#tabla-convocatoria-dpto').dataTable({
                    "bPaginate": false
                });
                $("#listados").hide();
            });
