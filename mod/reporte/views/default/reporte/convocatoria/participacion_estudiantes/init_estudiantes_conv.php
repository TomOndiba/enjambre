<h2 class="titulo-reportes title-legend">Reporte Estudiantes en Convocatoria</h2>
...
<script>
    function verConvocatoriasByDpto(element){
        ...
        $("#result").empty();
        elgg.get('ajax/view/reporte/convocatoria/participacion_estudiantes/convocatorias_by_dpto', {
            timeout: 30000,
            data: {
