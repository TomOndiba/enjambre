<h2 class="titulo-reportes title-legend">Reporte de Evaluadores de una Convocatoria</h2>
...
<script>
    ...
    function verConvocatoriasD(element){
        ...
        elgg.get('ajax/view/reporte/convocatoria/evaluadores_conv/convocatorias_por_dpto', {
            timeout: 30000,
            data: {
                dpto: dpto,
