...
$datos = elgg_get_estadisticas_evaluadores($conv, "es_evaluador_convocatoria");
...
<div>
    <div>
        <ul class="tabs-coordinacion">
            ...
            <li onclick="verListado(this)" ><a href="#" class="tab-asesores" name="no-asignados" title="" rel="nofollow">Evaluadores</a></li>
        </ul>
        <div class="tabs-asesores">
            ...
            <div id="listados">
                ...
                <div id="imprimir">
                    <br>
                    <h2 class="titulo-reportes">Evaluadores de la Convocatoria: <?php echo $conv->name?></h2>
                    <br>
                    <form action="http://<?php echo elgg_get_url_server()?>/reporte/imprimir_excel.php" method="post" target="_blank" id="FormularioExportacion">
                        <a onclick="imprimirExcel('tabla-evaluadores-conv')">Exportar a Excel</a>
                        <input type="hidden" id="contenido_excel" name="contenido" />
                    </form>
                    <table id="tabla-evaluadores-conv" class="responstable">
        ...
        <script>
            ...
            function consultarTabla() {
                $("#tabla-evaluadores-conv_filter label input").val("");
                var busqueda = "";
                ...
                $("#tabla-evaluadores-conv_filter label input")
                        .val(busqueda)
                        .change();
            }
            ;
            ...
            $(document).ready(function() {
                var table = $('#tabla-evaluadores-conv').dataTable({
                    "bPaginate": false
                });
                $("#listados").hide();
            });
