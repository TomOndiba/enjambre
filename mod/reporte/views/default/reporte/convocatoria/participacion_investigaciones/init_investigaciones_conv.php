<h2 class="titulo-reportes title-legend">Reporte Investigaciones en Convocatoria</h2>
...
$select_departamento = elgg_view('input/dropdown', array(
    ...
    'onchange' => 'verConvocatorias2ByDpto(this)',
...
<script>
    function verConvocatorias2ByDpto(element){
        var departamento = $(element).val();
        $("#result").empty();
        elgg.get('ajax/view/reporte/convocatoria/participacion_investigaciones/convocatorias_by_dpto2', {
            timeout: 30000,
            data: {
