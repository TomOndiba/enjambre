...
$datos = elgg_get_grupos_convByDpto($conv);
...
<div>
    <div>
        <ul class="tabs-coordinacion">
            ...
            <li onclick="verListado(this)" ><a href="#" class="tab-asesores" name="no-asignados" title="" rel="nofollow">Grupos de Investigación</a></li>
        </ul>
        <div class="tabs-asesores">
            ...
            <div id="listados">
                ...
                <div id="imprimir">
                    <br>
                    <h2 class="titulo-reportes">Grupos de Investigación de<?php echo get_entity($conv)->name ?></h2>
                    <form action="http://<?php echo elgg_get_url_server() ?>/reporte/imprimir_excel.php" method="post" target="_blank" id="FormularioExportacion">
                        <a onclick="imprimirExcel('tabla-grupos-conv')">Exportar a Excel</a>
                        <input type="hidden" id="contenido_excel" name="contenido" />
                    </form>
                    <table id="tabla-grupos-conv" class="responstable">
        ...
        <script>
            ...
            function consultarTabla() {
                $("#tabla-grupos-conv_filter label input").val("");
                var busqueda = "";
                ...
                $("#tabla-grupos-conv_filter label input")
                        .val(busqueda)
                        .change();
            }
            ;
            ...
            $(document).ready(function() {
                var table = $('#tabla-grupos-conv').dataTable({
                    "bPaginate": false
                });
                $("#listados").hide();
            });
