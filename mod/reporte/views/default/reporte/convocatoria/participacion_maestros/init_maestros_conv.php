<h2 class="titulo-reportes title-legend">Reporte Maestros en Convocatoria</h2>
...
$select_departamento = elgg_view('input/dropdown', array(
    ...
    'onchange' => 'verConvocatoriasByDpto3(this)',
...
<script>
    function verConvocatoriasByDpto3(element){
        var departamento = $(element).val();
        $("#result").empty();
        elgg.get('ajax/view/reporte/convocatoria/participacion_maestros/convocatorias_by_dpto3', {
            timeout: 30000,
            data: {
