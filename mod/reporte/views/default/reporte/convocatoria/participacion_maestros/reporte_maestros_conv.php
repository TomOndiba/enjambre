...
$datos = elgg_get_maestros_convByDpto($conv);
    ...
    <div>
        ...
        <div class="tabs-asesores">
            ...
            <div id="listados">
                ...
                <br>
                <div id="imprimir">
                    <h2 class="titulo-reportes">Maestros participantes en la Convocatoria <?php echo get_entity($conv)->name ?></h2>
                    <br>
                    <form action="http://<?php echo elgg_get_url_server() ?>/reporte/imprimir_excel.php" method="post" target="_blank" id="FormularioExportacion">
                        <a onclick="imprimirExcel('tabla-maestros-conv')">Exportar a Excel</a>
                        <input type="hidden" id="contenido_excel" name="contenido" />
                    </form>
                    <table id="tabla-maestros-conv" class="responstable">
        ...
        <script>
            ...
            function consultarTabla() {
                $("#tabla-maestros-conv_filter label input").val("");
                var busqueda = "";
                ...
                $("#tabla-maestros-conv_filter label input")
                        .val(busqueda)
                        .change();
            }
            ;
            ...
            $(document).ready(function() {
                var table = $('#tabla-maestros-conv').dataTable({
                    "bPaginate": false
                });
                $("#listados").hide();
            });
