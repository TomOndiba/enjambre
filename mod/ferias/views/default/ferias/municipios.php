...
$select_municipio = elgg_view('input/pulldown', array(
        "internalname" =>  "municipios[]",
        "js" =>  "multiple='true'",
        "id"=>"municipios",
        'required'=>'true'
));
...
<div class="div-datos2">
    <label>Departamento :</label><br />$select_departamento<br>
</div>       
<div class="div-datos2">
    <label>Municipio:</label> <i>(Para seleccionar varios municipios mantenga presionada la tecla Ctrl)</i><br /><br>
   $select_municipio    
       <br><br>
</div>  
