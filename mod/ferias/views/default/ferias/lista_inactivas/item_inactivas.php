<?php
/**
 * Vista que imprime en pantalla un recuadro con la información básica de la feria que este inactiva
 */

$entity = $vars['entity'];
//$feria = new ElggFeria($entity->guid);
$feria = get_entity($entity->guid);
...
echo "<div class='item-convocatoria'>";
    ...
    echo "<div class='menu-item-coordinacion'>".elgg_view("ferias/lista_inactivas/option_inactivas", $var)."</div>";
