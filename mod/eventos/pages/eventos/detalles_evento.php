...
elgg_push_breadcrumb($title, "eventos/detalles/{$guid}/{$id_conv}");



$params = array ('id_conv'=>$id_conv,'id'=>$guid, 'nombre_conv'=>$entity->name, 'nombre'=>$evento->nombre_evento, 'fecha_inicio'=>$evento->fecha_inicio, 'tipo_evento'=>$evento->tipo_evento, 
...
$content.= elgg_view('eventos/profile_evento', $params);
