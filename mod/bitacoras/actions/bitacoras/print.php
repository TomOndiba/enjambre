...
//
    ...
    case 102:
        ...
        $header = json_decode(get_input('header'));
        $tabla = json_decode(get_input('data'));
        $w=json_decode(get_input('ancho'));
        ...
        $pdf->MultiCell(150, 5, utf8_decode($titulo), 0, 'C');
        $pdf->Ln(4);


        //tabla de los estudiantes del grupo
        $pdf->pintarTable($header, $tabla, $w);
        $pdf->Ln(8);
