...
class formato_valoracion_maestro_oral extends FPDF {
...
// Número de página
    ...
    function datos($guid_ev) {
        $evaluacion = new ElggEvalMaestroOral($guid_ev);

        $this->SetFillColor(181, 181, 181);
        $this->SetTextColor(0, 0, 0);
        $this->SetFont('Arial', 'B', 12);

        $this->MultiCell(190, 6, utf8_decode("VALORACIÓN PONENCIA DEL MAESTRO(A)(ORAL)"), 1, 'C', 'true');
