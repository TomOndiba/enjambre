...
/**
 * Calse que referencia la Bitácora No. 4, para imprimirla en PDF.
...
class Bitacora4 extends FPDF {

// Cabecera de página
    function Header() {
        $this->SetFont('Arial', 'B', 14);
        $this->SetTextColor(238, 188, 6);
        $this->Cell(0, 0, 'BITACORA No. 4. DEFINICION DE LA TRAYECTORIA DE INDAGACIÓN', 0, 0, 'I');
        $this->Ln(5);
    }
