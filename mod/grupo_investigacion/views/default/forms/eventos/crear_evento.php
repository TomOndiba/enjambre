...
<div>
    <label>Hora de Inicio del Evento (HH:mm, formato de 24 horas):</label> $hora_input
</div>
 
   <div>
    <label>Hora de Fin del Evento (HH:mm, formato de 24 horas):</label> $hora_input2
</div> 
...
<script>
    $(document).ready(function() {
        ...
        $(".elgg-form-eventos-crear-evento").validate({/*sustituir "formulario" por el id de vuestro formulario*/
            rules: {
