...
foreach ($entities as $entity) {
    ...
    $cron.=elgg_view("asesorias/lista_2/item", $entity_data);
}
...
<div id="modalHistorial" class="reveal-modal">
    <div class="close-reveal-modal"></div>
    <div class="form-asesor-evaluador" id="pop-up-form">
        <div class='titulo-pop-up'>
            <h2>Historial de Asesorias</h2>
        </div>
        <div class="content-pop-up" id='content-pop-up-historial' style='padding-top: 10px;'>
...
<script>
    ...
    function verHistorial(asesoria) {
        elgg.get('ajax/view/asesorias/ver_historial', {
            timeout: 30000,
            data: {
                asesoria: asesoria,
            },
            success: function (result, success, xhr) {
                $('#content-pop-up-historial').html(result);
            },
        });
    }
