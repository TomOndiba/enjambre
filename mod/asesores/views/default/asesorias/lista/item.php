...
if ($asesoria->modo == "Online") {
    if (sizeof($sala) > 0) {
        ...
        $titulo = "Agregar Sala";
        $url_final = '<a class="" href="#" data-reveal-id="myModal2" onclick=\'getAddWebinar("' . $user->guid . '","' . $inv . '","' . $asesoria->guid . '")\'>Crear Sala</a> ';
    }
} else {
