...
// obtiene la entidad que contiene el archivo, si es una Red tematica o un Grupo de Investigacion no muestra las opciones de editar, eliminar etc.
  ...
  if($container->getSubtype()=="red_tematica"||$container->getSubtype()=="grupo_investigacion" || $container->getSubtype()=="institucion"|| $container->getSubtype()=="feria"){
    ...
    $header="<div class='titulo-list-group'>"
            . "<a href='$url' class=\"link-button\">Descargar</a> "
            . "</div>";
    $metadata=$header; 
