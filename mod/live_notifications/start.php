...
function live_notifications_page_handler($page) {
    ...
    switch ($page_type) {
        case 'notificaciones':
            include "$live_notifications_dir/ver_todas.php";
            break;
        case 'ajax':
        ...
        case 'pull':
            ...
            break;
        default:
            set_input('annotation', $page_type);
            include "$live_notifications_dir/ver.php";
            break;
    }
    return true;
}
...
function live_notifications_notifier() {
    ...
    if (elgg_is_logged_in()) {
        ...
        $text_final = "<a id ='live_notifications_link'>{$text}</a>";
...
function add_new_notification($to_guid, $from_guid, $type, $entity_guid, $description) {
    elgg_add_user_notification($to_guid);
