...
// Redirecciona a la Vista respectiva de Red Temática o Grupo de Investigación, dependiendo del Contenedor de la discusión
//$url= elgg_get_site_url();
//if($container->getSubtype()=="red_tematica"){
//    forward("{$url}redes_tematicas/discusiones/$container_guid");
//}
//else if($container->getSubtype()=="grupo_investigacion"){
//    forward("{$url}grupo_investigacion/discusiones/$container_guid");
//    
//}
