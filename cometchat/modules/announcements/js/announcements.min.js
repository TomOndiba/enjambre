...
function getTimeDisplay(ts){var ap="";var hour=ts.getHours();var minute=ts.getMinutes();var todaysDate=new Date();var todaysDay=todaysDate.getDate();var date=ts.getDate();var month=ts.getMonth();var armyTime=<?php  echo $armyTime; ?>;if(!armyTime){if(hour>11){ap="pm";}else{ap="am";}
