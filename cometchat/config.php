...
define('BASE_URL','/enjambre/cometchat/');
...
$trayicon[] = array('chatrooms','Chatrooms','modules/chatrooms/index.php','_popup','560','300','','1','1');
...
$minHeartbeat = '1500';			// Minimum poll-time in milliseconds (1 second = 1000 milliseconds)
$maxHeartbeat = '6000';			// Maximum poll-time in milliseconds
$fullName = '0';			// If set to yes, both first name and last name will be shown in chat conversations
$searchDisplayNumber = '100';			// The number of users in Whos Online list after which search bar will be displayed
$thumbnailDisplayNumber = '40';			// The number of users in Whos Online list after which thumbnails will be hidden
$typingTimeout = '5000';			// The number of milliseconds after which typing to will timeout
$idleTimeout = '1500';			// The number of seconds after which user will be considered as idle
...
$notificationTime = '2500';			// The number of milliseconds for which a notification will be displayed
$announcementTime = '10000';			// The number of milliseconds for which an announcement will be displayed
...
$googleDesktopNotifications = '1';			// If yes, Google desktop notifications will be enabled for Google Chrome
...
define('MEMCACHE','2');				// Set to 0 for disable caching, 1 for memcaching, 2 for file caching, 3 for Memcachier, 4 for APC, 5 for Wincache, 6 for SQLite & 7 for Memcached
