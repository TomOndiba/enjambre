        ...
        $.cometchat = $.cometchat || function(){
           ...
           arguments.callee.userDoubleClick = function(listing) {
            ...
            arguments.callee.notify = function(title, image, message, clickEvent, id, msgid) {
                if (navigator.userAgent.toLowerCase().indexOf('opr') < 0 && navigator.userAgent.toLowerCase().indexOf('chrome') > - 1 && settings.googleDesktopNotifications == 1 ) {
                    var havePermission = window.webkitNotifications.checkPermission();
                    if (havePermission == 0 && typeof title != 'undefined' && typeof image != 'undefined' && typeof message != 'undefined') {
                        if (typeof id != 'undefined') {
                            if (typeof  ccvariable.desktopNotification[id] == "undefined") {
                                ccvariable.desktopNotification[id] = {};
                            }
                            ccvariable.desktopNotification[id][msgid] = window.webkitNotifications.createNotification(
                            ...
                            ccvariable.desktopNotification[id][msgid].show();
                        } else {
                            ccvariable.desktopNotification = window.webkitNotifications.createNotification(
                                    image, /* Image to be displayed*/
                                    title, /* title of notification*/
                                    message/* message to be displayed*/
                            );
                            ccvariable.desktopNotification.onclick = function () {
                                if (typeof clickEvent == 'function') {
                                    clickEvent();
                                }
                            }
                            ccvariable.desktopNotification.show();
                        }
                    }
                }
            };
