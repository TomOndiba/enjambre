...
class ElggUser extends ElggEntity implements Friendable {
    ...
    function addRequestFriend($friend_guid) {
        return user_add_request_friend($this->getGUID(), $friend_guid);
    }

    function removeRequestFriend($friend_guid) {
        return user_remove_request_friend($this->getGUID(), $friend_guid);
    }
    /**
    ...
    function isRequestFrient($user_guid){
         return user_is_request_friend($this->getGUID(), $user_guid);
    }
