...
class ElggAnnotation extends ElggExtender {
	...
	public function getObjectFromID($id) {
        ...
        public function annotate($name, $value, $access_id = ACCESS_PUBLIC, $owner_id = 0, $vartype = "") {
		if ((int) $this->id > 0) {
			return create_annotation($this->id, $name, $value, $vartype, $owner_id, $access_id);
		} else {
                    elgg_echo("creador=".$owner_id);
		}
		return true;
	}
}
