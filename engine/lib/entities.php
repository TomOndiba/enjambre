 ...
 * @access private
 */
function disable_entity($guid, $reason = "", $recursive = false) {
	global $CONFIG;
...
/**
 * Returns an array of disabled entities with optional filtering.
 *
 * Entities are the basic unit of storage in Elgg.  This function
 * provides the simplest way to get an array of entities.  There
 * are many options available that can be passed to filter
 ...
 * @link http://docs.elgg.org/DataModel/Entities/Getters
 */
function elgg_get_disabled_entities(array $options = array()) {
	global $CONFIG;
	...
	// Add access controls
	$query .= get_access_disabled_sql_suffix('e');
